...
def get_final_output():
    ...
    final_output.append("results/counts/all_fpkm.tsv")
    final_output.append("results/counts/all_tpm.tsv")
...
def get_sample_strandedness(wildcards):
    if str(units.loc[wildcards.sample].loc[wildcards.unit, "strandedness"]) == "yes":
        return "++,--"
    elif str(units.loc[wildcards.sample].loc[wildcards.unit, "strandedness"]) == "reverse":
        return "--,++"
    else:
        return "none"
